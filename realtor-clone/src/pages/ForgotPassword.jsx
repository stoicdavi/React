  ...
  return (
       ...
       <section>
        ...
        <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg mt-3'>
          <p className='mb-3'>Don'have an account? <Link to='/sign-up' className='text-red-500 hover:text-red-700 transition duration-200 ' >Sign up</Link></p>
          <p>
            <Link to='/signin' className='text-blue-500 hover:text-blue-700 transition duration-600'>Sign in instead</Link>
          </p>
    
          </div>
          <button className='w-full py-3 mt-4 text-lg text-white bg-blue-500 hover:bg-blue-700 transition duration-200 rounded hover:shadow-gray-500 active:bg-blue-900 uppercase ease-in-out'>Send reset password</button>
