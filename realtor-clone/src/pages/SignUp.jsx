   ...
   <section>
    ...
    <div className='flex flex-wrap justify-center items-center px-6 py-12 max-w-6xl mx-auto'>
      ...
      <div  className='w-full md:w-[67%] lg:w-[40%] mb-12 md:mb-6 lg:ml-20'>
       <form>
        <div>
        <input className="w-full px-4 py-2 mb-4 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out" type="text" id="name"  placeholder="Full name" value={name} onChange={onChange} 
    />
    ...
    <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg mt-3'>
      <p className='mb-3'>Have an account? <Link to='/signin' className='text-red-500 hover:text-red-700 transition duration-200 ' >Sign in</Link></p>
      <p>
        <Link to='/forgot-password' className='text-blue-500 hover:text-blue-700 transition duration-600'>Forgot Password?</Link>
      </p>

      </div>
      <button className='w-full py-3 mt-4 text-lg text-white bg-blue-500 hover:bg-blue-700 transition duration-200 rounded hover:shadow-gray-500 active:bg-blue-900 uppercase ease-in-out'>Sign up</button>
